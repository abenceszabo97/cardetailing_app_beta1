      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800 rounded-2xl p-8">
          ...
          <Button
            ...
            className="w-full bg-white hover:bg-gray-100 text-gray-900 font-semibold py-6 rounded-xl flex items-center justify-center gap-3 transition-all shadow-lg"
          ...
          <p className="text-slate-500 text-xs text-center mt-6">
            A bejelentkezéssel elfogadod az Általános Szerződési Feltételeket
          </p>
        </div>
